...
class _MyAppState extends State<MyApp> {
  ...
  final GoRouter _router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: ScreenMainPage.routeName,
        builder: (BuildContext context, GoRouterState state) => ScreenMainPage(),
      ),
      GoRoute(
      ...
      GoRoute(
        path: ScreenWeather.routeName,
        builder: (BuildContext context, GoRouterState state) => ScreenWeather(),
      ),
    ],
  );
